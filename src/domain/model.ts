...
export const defaultProfile: CandidateProfile = {
  id: 'olfa',
  headline: 'Senior Business Analyst — Capital Markets & Business Transformation',
  yearsExperience: 10,
  targetRoles: [
  ...
  certifications: ['PMP', 'PSPO I', 'PRINCE2', 'ISTQB'],
  languages: [],
  resumeVersions: [],
...
export const defaultPreferences: CandidatePreferences = {
  ...
  excludedCompanies: [],
  excludedKeywords: ['internship', 'graduate program', 'entry level', 'entry-level', 'helpdesk'],
  includeKeywords: [],
  preferredDomains: [
    'financial services',
    'banking',
